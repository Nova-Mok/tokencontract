...
function App() {
  ...
  const contractAddress = '0x9a9228024A6904ff44d17A9f0c7D0DA4078d46F1';
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">Mac Coin Project</span>
        <img className="inline p-3 ml-2" src="https://i.imgur.com/5JfHKHU.png" alt="Mac Coin" width="60" height="30" />
      </h2>
